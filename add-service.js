...
form.addEventListener("submit", async event => {
  ...
  try {
    ...
    console.error(error); const code=error?.code||"unknown";status.textContent=`لم يُرسل الطلب. رمز الخطأ: ${code}. تأكد من نشر قواعد الأمان الخاصة بالنسخة 7.0.`; button.disabled = false;
  }
});
